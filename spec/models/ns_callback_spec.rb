...
describe NsCallback do
  ...
  context "encrypt_values" do 
    ...
    it "should encrypt the settings with type password" do 
      ns_callback = Factory.build(:ns_callback, setting1_name: 'name1', setting1_type: 'text', setting1_value: 'value1', setting2_name: 'name2', setting2_type: 'password', setting2_value: 'password123')
      ns_callback.save.should be_true
      ns_callback.reload
      ns_callback.setting2_value.should == "password123"
    end
  end
